...
import { default as VChart } from '../../victoryChart';
...
export default class Login extends React.Component {
    constructor() {
        ...
        this.socket = SocketIOClient('https://7ee8f9f5.ngrok.io');
    }
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                />
                <TouchableHighlight
                    onPress={() => this.handlePersonnality(this.state.text)}
                >
                    <Text>Submit</Text>
                </TouchableHighlight>
                <TouchableHighlight
